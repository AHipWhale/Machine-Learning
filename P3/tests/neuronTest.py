...
class MyTestCase(unittest.TestCase):
    """
    Bij al deze test waar ik dezelfde parameters moet gebruiken als bij de perceptron. Heb ik niet de bias overgenomen
    ...
    def test_And(self):
        ...
        """Met deze parameters is de output net niet goed. De output van de neuron waar de input [1, 1] is, is de output 0.5.
           ...
           maar dit zou wellicht nog wat lager kunnen. Dit zorgt ervoor dat de output meer naar de 1 leunt 
           maar de rest van de outputs allemaal nog meer naar de 0."""
